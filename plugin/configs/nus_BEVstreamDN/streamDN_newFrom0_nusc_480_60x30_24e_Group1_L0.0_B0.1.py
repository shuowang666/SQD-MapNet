...
model = dict(
    ...
    head_cfg=dict(
        ...
        dn_cfg=dict(  # CdnQueryGenerator
            ...
            num_queries=num_queries,
            num_classes=num_class,
            noise_scale=dict(label=0.0, box=0.1, pt=0.0),  # 0.5, 0.4 for DN-DETR
            group_cfg=dict(dynamic=False, num_groups=1, num_dn_queries=40),
...
train_pipeline = [
    ...
    dict(type='Collect3D', keys=['img', 'vectors', 'id'], meta_keys=(
